...
class ProductAdmin(admin.ModelAdmin):
    ...
    list_display = ('prod_code', 'reg_code', 'durcode1', 'durcode2', 'durcode3', 'durcode4', 'ing_code')
    list_filter = ['durcode1', 'durcode2', 'durcode3', 'durcode4']
...
class IngreFormAdmin(admin.ModelAdmin):
    ...
    list_display = ('ing_form_id', 'ing_name_kr', 'form', 'desc_id', 'note', 'ing_id', 'code' )
    list_filter = ['form', 'code']
    search_fields = ['ing_form_id', 'ing_name_kr']
