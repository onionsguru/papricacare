...
class IngreDesc(models.Model):
    desc_id = models.CharField(primary_key = True, max_length = MAX_CODE_STR, default='TBD')
...
class IngreForm(models.Model):
    ing_form_id = models.CharField(primary_key = True, max_length = MAX_CODE_STR, default='TBD') 
...
class Ingredient(models.Model):
    ing_code = models.CharField(primary_key = True, max_length = MAX_CODE_STR, default='TBD') 
...
class Registration(models.Model):
    reg_code = models.CharField(primary_key = True, max_length = MAX_CODE_STR, default='TBD') 
...
class Product(models.Model):
    prod_code = models.CharField(primary_key = True, max_length = MAX_CODE_STR, default='TBD') 
    reg_code = models.ForeignKey(Registration, related_name='drugs', on_delete=models.CASCADE, blank=True, null=True)
    durcode1 = models.CharField(max_length = MAX_CODE_STR, default='TBD') 
    durcode2 = models.CharField(max_length = MAX_CODE_STR, default='TBD') 
    durcode3 = models.CharField(max_length = MAX_CODE_STR, default='TBD') 
    durcode4 = models.CharField(max_length = MAX_CODE_STR, default='TBD') 
